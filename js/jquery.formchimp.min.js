/*!  v1.2.2 | Fabio Quarantini - http://www.fabioquarantini.com */ ! function(a, b, c, d) { a.fn.formchimp = function(b) { var d, e = a(this),
            f = a("body"),
        ...
        a.extend(i, b), a(e).on("submit", function(b) { b.preventDefault(), f.removeClass("mc-success mc-error").addClass("mc-loading"), 0 === a("." + i.responseClass).length ? d = a("<div/>").addClass(i.responseClass).appendTo(i.appendElement) : d.html(""), a.ajax({ url: i.url, data: a(this).serialize(), dataType: "jsonp" }).done(function(b) { i.debug && console.log(JSON.stringify(b)); var e = b.msg;
